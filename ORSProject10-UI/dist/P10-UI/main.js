...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.intercept = function (req, next) {
        // Check if user is authenticated (token available in localStorage)
        if (localStorage.getItem('fname') && localStorage.getItem('token')) {
            // Clone request and add Authorization headers
            req = req.clone({
                setHeaders: {
                    "withCredentials": "true",
                    "name": "DIPINSHI",
                    Authorization: this.http.getToken() // Add token from HttpService
                }
            });
        }
        // Optional: Log the request headers to check Authorization header
        console.log(req.headers.get("Authorization") + "------------------->>>");
        // If the request is for OTP verification, you can customize the header here
        if (req.url.includes('/verifyOtp')) {
            // You can add specific OTP headers if required
            req = req.clone({
                setHeaders: {
                    'Otp-Requested': 'true' // Example custom header for OTP
                }
            });
        }
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(httpService, dataValidator, router, cookieService, route, serviceLocator) {
        ...
        this.inputerror = {}; // Used for capturing input validation errors
        // Used to fetch session expired URL or message (Could be removed if not used in the application)
        this.userparams = {
            url: '',
            sessionExpiredMsg: '',
            methodType: '',
     ...
     * Checks for any error message or logout success message.
     */
    LoginComponent.prototype.ngOnInit = function () {
        // Restore message from shared form if redirected with error
        ...
        // Check if logout success message is to be shown
        var isLogout = '';
        this.serviceLocator.getPathVariable(this.route, function (params) {
            isLogout = params["userparams"];
            console.log('Logout flag received:', isLogout);
        });
        if (isLogout === 'true') {
    ...
    /**
     * Check session expiry or login redirection params
     * Uses query parameters for session expiry message and URL
     */
     ...
     * Validates loginId and password fields
     */
    ...
    /**
     * Login submission
     * Handles the login process and redirects on success or failure
     */
    LoginComponent.prototype.signIn = function () {
        var _self = this;
        this.form.error = false;
        var requestedUrl = this.httpService.userparams.url; // If login is from a protected route
        console.log('signIn data:', this.form);
...
module.exports = "<app-navbar></app-navbar>\r\n\r\n<style>\r\n  .grad {\r\n    background-image: linear-gradient(to bottom right, rgb(199, 7, 110), rgb(41, 41, 41));\r\n    background-repeat: no-repeat;\r\n    background-size: 100%;\r\n    padding-bottom: 25px;\r\n  }\r\n\r\n  .log1 {\r\n    padding-top: 13%;\r\n  }\r\n\r\n  .input-group-addon {\r\n    box-shadow: 9px 8px 7px #001a33;\r\n  }\r\n</style>\r\n\r\n<!-- User form wrapped in a background -->\r\n<div class=\"row\" style=\"padding: 2% 0; background: url(assets/files/bg6000.jpg) no-repeat center center fixed; background-size: cover; width: 100%; height: auto;\">\r\n\r\n  <!-- Centering the form -->\r\n  <div class=\"col-sm-4\"></div>\r\n  <div class=\"col-sm-4\">\r\n    <div class=\"card\">\r\n      <div class=\"card-body input-group-addon grad\">\r\n\r\n        <!-- User form starts here -->\r\n        <form name=\"userForm\">\r\n\r\n          <!-- Form heading, displays either \"Add User\" or \"Update User\" based on form data -->\r\n          <h2 class=\"text-primary font-weight-bold text-center\">\r\n            {{ form.data.id > 0 ? ('Update User' | translate) : ('Add User' | translate) }}\r\n          </h2>\r\n\r\n          <!-- Displaying form submission messages -->\r\n          <div *ngIf=\"form.message\" [ngClass]=\"{'alert alert-success alert-dismissible': !form.error, 'alert alert-danger alert-dismissible': form.error}\">\r\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n            {{form.message}}\r\n          </div>\r\n\r\n          <!-- Role -->\r\n          <div>\r\n            <span class=\"pt-2\"><b>{{'Role Name' | translate }}</b></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-user grey-text\"></i></div>\r\n                </div>\r\n                <!-- Role dropdown with two-way data binding -->\r\n                <select class=\"form-control\" name=\"roleId\" [(ngModel)]=\"form.data.roleId\">\r\n                  <option [ngValue]=\"undefined\">{{' Select Role' | translate }}</option>\r\n                  <option *ngFor=\"let obj of form.preload.roleList\" [value]=\"obj.key\">{{obj.value}}</option>\r\n                </select>\r\n              </div>\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.roleId\" class=\"alertRedColor text-danger\">{{'role' | translate}}</span>\r\n          </div>\r\n\r\n          <!-- First Name -->\r\n          <div>\r\n            <span class=\"pt-2\"><b>{{'First Name' | translate }}</b></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-user-circle grey-text\"></i></div>\r\n                </div>\r\n                <!-- First Name input -->\r\n                <input type=\"text\" name=\"fn\" [(ngModel)]=\"form.data.firstName\" class=\"form-control\" placeholder=\"{{'Enter First Name' | translate}}\">\r\n              </div>\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.firstName\" class=\"alertRedColor text-danger\">{{'firstname' | translate}}</span>\r\n          </div>\r\n\r\n          <!-- Last Name -->\r\n          <div>\r\n            <span class=\"pt-2\"><b>{{'Last Name' | translate }}</b></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-user grey-text\"></i></div>\r\n                </div>\r\n                <!-- Last Name input -->\r\n                <input type=\"text\" name=\"ln\" [(ngModel)]=\"form.data.lastName\" class=\"form-control\" placeholder=\"{{'Enter Last Name' | translate}}\">\r\n              </div>\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.lastName\" class=\"alertRedColor text-danger\">{{'lastname' | translate}}</span>\r\n          </div>\r\n\r\n          <!-- Login ID -->\r\n          <div>\r\n            <span class=\"pt-2\"><b>{{'login Id' | translate }}</b></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-envelope grey-text\"></i></div>\r\n                </div>\r\n                <!-- Login ID input -->\r\n                <input type=\"text\" name=\"loginId\" [(ngModel)]=\"form.data.loginId\" class=\"form-control\" placeholder=\"{{'Enter Login Id' | translate}}\">\r\n              </div>\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.loginId\" class=\"alertRedColor text-danger\">{{'email' | translate}}</span>\r\n          </div>\r\n\r\n          <!-- Password -->\r\n          <div>\r\n            <span class=\"pt-2\"><b>{{'Password' | translate }}</b></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-key grey-text\"></i></div>\r\n                </div>\r\n                <!-- Password input -->\r\n                <input type=\"password\" name=\"pwd\" [(ngModel)]=\"form.data.password\" class=\"form-control\" placeholder=\"{{'Enter Password' | translate}}\">\r\n              </div>\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.password\" class=\"alertRedColor text-danger\">{{'password' | translate}}</span>\r\n          </div>\r\n\r\n          <!-- Mobile -->\r\n          <div>\r\n            <span class=\"pt-2\"><b>{{'Mobile' | translate }}</b></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-phone grey-text\"></i></div>\r\n                </div>\r\n                <!-- Mobile input -->\r\n                <input type=\"text\" name=\"phone\" maxlength=\"10\" [(ngModel)]=\"form.data.phone\" class=\"form-control\" placeholder=\"{{'Enter Mobile Number' | translate}}\">\r\n              </div>\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.phone\" class=\"alertRedColor text-danger\">{{'phone' | translate}}</span>\r\n          </div>\r\n\r\n          <!-- Alternate Mobile -->\r\n          <div>\r\n            <span class=\"pt-2\"><b>{{'Alternate Mobile' | translate }}</b></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-mobile grey-text\"></i></div>\r\n                </div>\r\n                <!-- Alternate Mobile input -->\r\n                <input type=\"text\" name=\"alternateMobile\" maxlength=\"10\" [(ngModel)]=\"form.data.alternateMobile\" class=\"form-control\" placeholder=\"{{'Enter Alternate Number' | translate}}\">\r\n              </div>\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.alternateMobile\" class=\"alertRedColor text-danger\">{{'mobile' | translate}}</span>\r\n          </div>\r\n\r\n          <!-- DOB -->\r\n          <div>\r\n            <span class=\"pt-2\"><b>{{'DOB' | translate }}</b></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-table grey-text\"></i></div>\r\n                </div>\r\n                <!-- Date of Birth input -->\r\n                <input type=\"date\" name=\"dob\" [value]=\"form.data.dob | date:'yyyy-MM-dd'\" (input)=\"form.data.dob=parseDate($event.target.value)\" class=\"form-control form-control-sm\" required>\r\n              </div>\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.dob\" class=\"alertRedColor text-danger\">{{'dob' | translate}}</span>\r\n          </div>\r\n\r\n          <!-- Gender -->\r\n          <div>\r\n            <span class=\"pt-2\"><b>{{'Gender' | translate }}</b></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-venus grey-text\"></i></div>\r\n                </div>\r\n                <!-- Gender dropdown -->\r\n                <select class=\"form-control\" name=\"gender\" [(ngModel)]=\"form.data.gender\">\r\n                  <option [ngValue]=\"undefined\">{{'Please select' | translate}}</option>\r\n                  <option value=\"Male\">{{'Male' | translate}}</option>\r\n                  <option value=\"Female\">{{'Female' | translate}}</option>\r\n                </select>\r\n              </div>\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.gender\" class=\"alertRedColor text-danger\">{{'gender' | translate}}</span>\r\n          </div>\r\n\r\n          <!-- Image Upload -->\r\n          <div>\r\n            <span class=\"pt-2\"><b>{{'Image' | translate }}</b></span>\r\n            <div class=\"col-sm-12\">\r\n              <img *ngIf=\"form.data.imageId\" [src]=\"'http://localhost:8084/User/profilePic/' + form.data.id\" height=\"55\" width=\"80\">\r\n              <img *ngIf=\"!form.data.imageId\" src=\"../../assets/files/default.jpg\" height=\"55\" width=\"80\">\r\n            </div>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-picture-o grey-text\"></i></div>\r\n                </div>\r\n                <!-- Image file input -->\r\n                <input type=\"file\" id=\"customFile\" name=\"imageId\" (change)=\"onFileSelect($event.target.files)\" accept=\"image/*\">\r\n              </div>\r\n              <span class=\"alertRedColor text-danger\">{{form.inputerror.image}}</span>\r\n            </div>\r\n          </div>\r\n\r\n          <!-- Status -->\r\n          <div>\r\n            <span class=\"pt-2\"><b>{{'Status' | translate }}</b></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-bell grey-text\"></i></div>\r\n                </div>\r\n                <!-- Status dropdown -->\r\n                <select class=\"form-control\" [(ngModel)]=\"form.data.status\" name=\"status\">\r\n                  <option [ngValue]=\"undefined\">{{' Select Status' | translate }}</option>\r\n                  <option value=\"Active\">{{'Active' | translate}}</option>\r\n                  <option value=\"Inactive\">{{'Inactive' | translate}}</option>\r\n                </select>\r\n              </div>\r\n            </div>\r\n            <span *ngIf=\"form.inputerror.status\" class=\"alertRedColor text-danger\">{{'status' | translate}}</span>\r\n          </div>\r\n\r\n          <!-- Submit Buttons -->\r\n          <div class=\"row pt-2 pl-2 pb-3\">\r\n            <div class=\"col-md-3\"></div>\r\n            <div class=\"pt-2\">\r\n              <!-- Save or Update button -->\r\n              <button *ngIf=\"!form.data.id\" (click)=\"onUpload()\" class=\"btn btn-success mr-2\">{{'Save' | translate}}</button>\r\n              <button *ngIf=\"form.data.id\" (click)=\"onUpload()\" class=\"btn btn-success mr-2\">{{'Update' | translate}}</button>\r\n              <!-- Link to User List -->\r\n              <a class=\"btn btn-warning mr-1\" [routerLink]=\"['/userlist']\" style=\"color: white;\">{{'List' | translate}}</a>\r\n            </div>\r\n          </div>\r\n\r\n        </form>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>\r\n"
...
var UserComponent = /** @class */ (function (_super) {
    ...
    /**
     * Submit user data (including file upload if present)
     */
    UserComponent.prototype.submit = function () {
        ...
        this.serviceLocator.httpService.post(this.api.save, this.form.data, function (res) {
            ...
            if (_self.fileToUpload) {
                console.log('Amisha');
                _self.myFile(); // Handle file upload
            }
    ...
    /**
     * Another submit method (seems redundant, possibly remove if not needed)
     */
    ...
    /**
     * Trigger file upload after form submission
     */
    ...
    UserComponent.prototype.test = function () {
        // Placeholder test method (currently unused)
    };
...
module.exports = __webpack_require__(/*! C:\Users\AA\Desktop\Proj_10_JWT\proj10_jwt\ORSProject10-UI\src\main.ts */"./src/main.ts");
